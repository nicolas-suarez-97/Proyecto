...
proc vTclWindow.top37 {base} {
    ...
    wm geometry $top 1002x721+101+112
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    ttk::combobox $site_3_0.tCo39 \
        -values 'Duitama','Sogamoso','Tunja' -justify center -state readonly \
        -textvariable combo3 -foreground {} -background {} -takefocus {} 
    vTcl:DefineAlias "$site_3_0.tCo39" "TCombobox3" vTcl:WidgetProc "Toplevel1" 1
    label $site_3_0.lab51 \
        -activebackground {#f9f9f9} -activeforeground black \
        -background {#d9d9d9} -foreground {#000000} -highlightcolor black \
        -text {Seleccione el lugar} 
    vTcl:DefineAlias "$site_3_0.lab51" "Label13" vTcl:WidgetProc "Toplevel1" 1
    label $site_3_0.lab52 \
        -activebackground {#f9f9f9} -activeforeground black \
        -background {#d9d9d9} -foreground {#000000} -highlightcolor black \
        -text {Ganancia Esperada} 
    vTcl:DefineAlias "$site_3_0.lab52" "Label14" vTcl:WidgetProc "Toplevel1" 1
    label $site_3_0.lab53 \
        -activebackground {#f9f9f9} -activeforeground black \
        -background {#ffffff} -foreground {#000000} -highlightcolor black \
        -textvariable ganancia 
    vTcl:DefineAlias "$site_3_0.lab53" "Label15" vTcl:WidgetProc "Toplevel1" 1
    label $site_3_0.lab54 \
        -background {#ffffff} -foreground {#000000} -text {$} 
    vTcl:DefineAlias "$site_3_0.lab54" "Label16" vTcl:WidgetProc "Toplevel1" 1
    ...
    place $site_3_0.lab45 \
        -in $site_3_0 -x 30 -y 500 -anchor nw -bordermode ignore 
    ...
    place $site_3_0.lab47 \
        -in $site_3_0 -x 290 -y 500 -width 159 -relwidth 0 -height 21 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab49 \
        -in $site_3_0 -x 470 -y 360 -width 489 -relwidth 0 -height 311 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab50 \
        -in $site_3_0 -x 560 -y 60 -width 339 -relwidth 0 -height 281 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but52 \
        -in $site_3_0 -x 150 -y 610 -width 159 -relwidth 0 -height 29 \
        -relheight 0 -anchor nw -bordermode ignore 
    ...
    place $site_3_0.tCo39 \
        -in $site_3_0 -x 290 -y 180 -width 167 -relwidth 0 -height 21 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab51 \
        -in $site_3_0 -x 20 -y 180 -anchor nw -bordermode ignore 
    place $site_3_0.lab52 \
        -in $site_3_0 -x 30 -y 530 -anchor nw -bordermode ignore 
    place $site_3_0.lab53 \
        -in $site_3_0 -x 290 -y 530 -width 159 -relwidth 0 -height 21 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab54 \
        -in $site_3_0 -x 290 -y 530 -anchor nw -bordermode ignore 
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.fra39 \
